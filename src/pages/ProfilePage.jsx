...
const profileDisplayFields = [
  ...
  { label: "Địa chỉ", valueKey: "address" },
];
...
const profileEditFields = [
  ...
  { label: "Địa chỉ", name: "address", as: "textarea" },
];
...
function ProfilePage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const nextProfile = normalizeProfile(response?.result || payload);
  ...
  return (
    <section className="page-section">
      <div className="page-wrap">
        ...
        >
          <div className="flex items-start justify-between gap-4 border-b border-stone-200 px-6 py-4 sm:px-8">
            <h2 className="font-display text-2xl font-semibold text-brand-brown">
              Chỉnh sửa hồ sơ
            </h2>
            <TextButton
